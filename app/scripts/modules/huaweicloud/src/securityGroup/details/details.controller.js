...
module.exports = angular
  .module('spinnaker.securityGroup.huaweicloud.details.controller', [
    require('@uirouter/angularjs').default,
    CONFIRMATION_MODAL_SERVICE,
    SECURITY_GROUP_READER,
  ])
  .controller('huaweicloudSecurityGroupDetailsController', [
    '$scope',
    '$state',
    ...
    function($scope, $state, resolvedSecurityGroup, app, confirmationModalService, securityGroupReader, $uibModal) {
      ...
      this.editSecurityGroup = function editSecurityGroup() {
        $uibModal.open({
          ...
          controller: 'huaweicloudUpsertSecurityGroupController as ctrl',
          size: 'lg',
          resolve: {
