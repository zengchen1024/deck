...
module.exports = angular
  ...
  .controller('huaweicloudUpsertSecurityGroupController', [
    ...
    'application',
    'securityGroup',
    'huaweicloudSecurityGroupTransformer',
    'securityGroupReader',
    function(
      $q,
      $scope,
      ...
      function initializeCreateMode() {
        return $q
          .all({
            accounts: AccountService.listAccounts('huaweicloud'),
          })
      ...
      function initializeSecurityGroupNames() {
        securityGroupReader.loadSecurityGroups('huaweicloud').then(function(securityGroups) {
      ...
      if ($scope.isNew) {
        $scope.securityGroup = huaweicloudSecurityGroupTransformer.constructNewSecurityGroupTemplate();
        $scope.securityGroup.application = application.name;
        initializeCreateMode();
        $scope.state.accountsLoaded = true;
      } else {
        $scope.securityGroup = huaweicloudSecurityGroupTransformer.prepareForEdit(securityGroup);
      ...
      this.submit = function() {
        ...
        $scope.taskMonitor.submit(function() {
          ...
          copyOfSG = huaweicloudSecurityGroupTransformer.prepareForSaving(copyOfSG);
