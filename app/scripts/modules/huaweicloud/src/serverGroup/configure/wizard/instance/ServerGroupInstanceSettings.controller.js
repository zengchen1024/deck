...
module.exports = angular
  .module('spinnaker.serverGroup.configure.huaweicloud.instanceSettings', [
    require('@uirouter/angularjs').default,
    require('angular-ui-bootstrap'),
    IMAGE_READER,
    require('../../../../instance/huaweicloudInstanceTypeSelectField.directive').name,
  ])
  .controller('huaweicloudServerGroupInstanceSettingsCtrl', [
    '$scope',
    '$controller',
    '$uibModalStack',
    '$state',
