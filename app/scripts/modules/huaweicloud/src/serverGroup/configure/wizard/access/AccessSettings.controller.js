...
module.exports = angular
  .module('spinnaker.serverGroup.configure.huaweicloud.accessSettings', [
    require('@uirouter/angularjs').default,
    require('angular-ui-bootstrap'),
    require('../../../../common/cacheBackedMultiSelectField.directive').name,
  ])
  .controller('huaweicloudServerGroupAccessSettingsCtrl', [
    '$scope',
    function($scope) {
      ...
      function getSecurityGroups() {
        ...
        if (!account || !region) {
          ...
          return _.get($scope.command.backingData.securityGroups, [account, 'huaweicloud', region]);
        }
      }
