...
module.exports = angular
  .module('spinnaker.huaweicloud.serverGroup.configure.configuration.service', [
  ...
  .factory('hwcServerGroupConfigurationService', [
    ...
    'cacheInitializer',
    'loadBalancerReader',
    function($q, huaweicloudImageReader, securityGroupReader, cacheInitializer, loadBalancerReader) {
      ...
      function getRegionalSecurityGroups(command) {
        var newSecurityGroups = _.get(
          command,
          ['backingData', 'securityGroups', command.credentials, 'huaweicloud'],
          {},
        );
      ...
      function refreshLoadBalancers(command, skipCommandReconfiguration) {
        return $q.then(loadBalancerReader.listLoadBalancers('huaweicloud')).then(function(loadBalancers) {
