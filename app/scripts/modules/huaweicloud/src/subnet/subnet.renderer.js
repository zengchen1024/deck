...
module.exports = angular
  .module('spinnaker.huaweicloud.subnet.renderer', [])
  .factory('huaweicloudSubnetRenderer', function() {
    var subnets;

    SubnetReader.listSubnetsByProvider('huaweicloud').then(function(list) {
      subnets = list;
    });
