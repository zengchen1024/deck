...
module(HUAWEICLOUD_MODULE, [
  ...
  require('./pipeline/stages/scaleDownCluster/scaleDownClusterStage.controller').name,
  require('./pipeline/stages/shrinkCluster/shrinkClusterStage.controller').name,
]).config(() => {
