...
module.exports = angular
  ...
  .controller('huaweicloudUpsertLoadBalancerController', [
    ...
    'loadBalancer',
    'isNew',
    'huaweicloudLoadBalancerTransformer',
    'securityGroupReader',
    function(
      $scope,
      $uibModalInstance,
      ...
      if (loadBalancer) {
        $scope.loadBalancer = huaweicloudLoadBalancerTransformer.convertLoadBalancerForEditing(loadBalancer);
      } else {
        $scope.loadBalancer = huaweicloudLoadBalancerTransformer.constructNewLoadBalancerTemplate();
      ...
      function updateSecurityGroups() {
        ...
        securityGroupReader.getAllSecurityGroups().then(function(securityGroups) {
          $scope.allSecurityGroups = _.get(securityGroups, [account, 'huaweicloud', region], []);
        });
      }
